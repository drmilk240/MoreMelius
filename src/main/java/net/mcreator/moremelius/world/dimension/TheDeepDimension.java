...
public class TheDeepDimension extends MoremeliusModElements.ModElement {
	public TheDeepDimension(MoremeliusModElements instance) {
		super(instance, 23);
	}
	...
	public void clientLoad(FMLClientSetupEvent event) {
		DimensionRenderInfo customEffect = new DimensionRenderInfo(128, true, DimensionRenderInfo.FogType.NORMAL, false, false) {
			...
			public Vector3d func_230494_a_(Vector3d color, float sunHeight) {
				return new Vector3d(0.050980392157, 0.043137254902, 0.254901960784);
			}
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("moremelius:the_deep"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
